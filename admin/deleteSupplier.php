        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table id="deletedSupplierTable" class="table table-striped table-bordered" style="width:100%">
...
<script src="../controllers/deletedSupplier.js"></script>
